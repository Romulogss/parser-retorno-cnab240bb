...
public class SegmentoB {
    ...
    public String sbCtrBanco;
    public String sbCtrLote;
    public String sbCtrRegistro;
    public String sbSrvRegisto;
    public String sbSrvSegmento;
    public String sbCnab1;
    public String sbDCompFavInscTipo;
    public String sbDCompFavInscNumero;
    public String sbDCompFavLogradouro;
    public String sbDCompFavNumero;
    public String sbDCompFavComplemento;
    public String sbDCompFavBairro;
    public String sbDCompFavCidade;
    public String sbDCompFavCep;
    public String sbDCompFavCepComplemento;
    public String sbDCompFavEstado;
    public String sbDCompPagVencimento;
    public String sbDCompPagVlrDocumento;
    public String sbDCompPagVlrAbatimento;
    public String sbDCompPagVlrDesconto;
    public String sbDCompPagVlrMora;
    public String sbDCompPagVlrMulta;
    public String sbDCompCodDocumento;
    public String sbAviso;
    public String sbUG;
    public String sbISPB;
